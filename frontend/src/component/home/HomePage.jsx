        ...
        <div className="home">
            <section>
                <header className="header-banner">
                    <img src="/img/hotel.webp" alt="Hotel" className="header-image"/>
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="keno-color">Keno Hotel</span>
                        </h1> <br />
            ...
            <h2 className="home-services">Services at <span className="keno-color">Keno Hotel</span></h2>

            <section className="service-section"><div className="service-card">
                <img src="img/ac.png" alt="Air Conditioning" />
                ...
                <div className="service-card">
                    <img src="img/mini-bar.png" alt="Mini Bar" />
                    <div className="service-details">
